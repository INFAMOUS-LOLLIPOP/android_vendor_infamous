...
ifneq ($(WITH_GMS),true)
PRODUCT_COPY_FILES += \
    vendor/infamous/prebuilt/common/bin/backuptool.sh:install/bin/backuptool.sh \
    vendor/infamous/prebuilt/common/bin/backuptool.functions:install/bin/backuptool.functions \
...
PRODUCT_COPY_FILES += \
    vendor/infamous/prebuilt/common/bin/otasigcheck.sh:install/bin/otasigcheck.sh
...
PRODUCT_VERSION_MAJOR = v1.2
PRODUCT_VERSION_MINOR = LP
